 ...
 * @returns {Wiki}
 **/
gitwiki.create = function(repoAddress,options){
 ...
 * @returns {Wiki}
 **/
gitwiki.open = function(repoAddress,options){
    ...
    try{
        ...
        if(e.gitError == gitteh.error.GIT_ENOTAREPO && options.createOnFail){
            return this.create(repoAddress,{overwrite:true});
        }
        throw e;
    }
 ...
 * @param {object} options
 **/
Wiki.prototype.createPage = function(title,options){
 ...
 * @returns {object}
 **/
Wiki.prototype.loadPage = function(page,options){
 ...
 * @returns {array}
 **/
Wiki.prototype.pageHistory = function(page,depth){
 ...
 * @returns {array}
 **/
Wiki.prototype.listPages = function(commitId){
    var pages = [];
    var entry;
    ...
    if(!commitId){
        ...
        var commitObj = this.repo.getCommit(this.head);
        var treeObj = this.repo.getTree(commitObj.tree);
 ...
 * @returns {array}
 **/
Wiki.prototype.compareRevisions = function(firstCommit,secondCommit,options){
    var defaults = {
        fileName: null,
        withContents: false
    }
 ...
 * @returns {array}
 **/
Wiki.prototype.history = function(depth){
